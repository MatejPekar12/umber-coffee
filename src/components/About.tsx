...
export function About() {
  return (
    <section id="about" className="bg-white py-28 md:py-36 px-6">
      <div className="max-w-6xl mx-auto">

        {/* Stats row */}
        <div className="grid grid-cols-3 gap-6 md:gap-12 mb-24 md:mb-32 border-b border-stone-100 pb-20 md:pb-28">
          {stats.map((stat, i) => (
            <motion.div key={stat.label} {...fadeUp(i * 0.12)} className="flex flex-col items-start">
              <span className="font-playfair text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-stone-900 leading-none tracking-tight">
                {stat.value}
              </span>
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-20 items-end">
          ...
          <motion.div {...fadeUp(0.15)}>
            <p className="text-stone-500 text-base leading-[1.8] max-w-md">
